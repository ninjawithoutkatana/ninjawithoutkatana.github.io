/* APPLICATION?edufile.wordcloud/v0.1(#edufile6.2.prerelease.0325) */ 
! function () {
     function n(n, t) {
               ...
               return n.invert = function (n) {
                    ...
                    n.translate = function (t) {
                         ...
                         return r = i.translate(t).clipExtent([
                              ...
                              e = o.translate([s - .307 * l, f + .201 * l]).clipExtent([
                                   [s - .425 * l + Fa, f + .12 * l + Fa],
                                   [s - .214 * l - Fa, f + .234 * l - Fa]
                              ]).stream(c).point,
                              u = a.translate([s - .205 * l, f + .212 * l]).clipExtent([
     ...
     oa.scale.pow = function () {
          ...
          oa.scale.category20b = function () {
               var palette = '1a535c-4ecdc4-f7c4f7-ff6b6b-ce4ca3-5bc0eb-2866a2-87ff87-e55934-ffb053'
                    .split('-').map(function (hex) {
                         return `#${hex}`;
                    });
               return oa.scale.ordinal().range(palette)
          },
               ...
               function n(n) {
                    n.each(function () {
                         var n, l = oa.select(this),
                              ...
                              M = (x.enter().append("path").attr("class", "domain"),
                                   oa.transition(x));
                         v.append("line"),
                              v.append("text");
                         var _ = v.select("line"),
...
d3.select("#random-palette").on("click", function () {
          paletteJSON("http://www.colourlovers.com/api/palettes/131576/Maddening_Caravan", {}, function (t) {
